...
\begin{titlepage}
  ...
  \vspace{1.4cm}
  \includegraphics[width=0.55\textwidth]{logo-soict-hust-1.png}

  \vfill

  {\Huge\bfseries Statistical Studies in Formula~1\par}
  \vspace{0.5cm}
  {\LARGE Lap-Time Distributions, Grid-Position Advantage,\\
   Home-Race Effects, and Pit-Stop Strategy\\(1950--2026)\par}
  ...
  \begin{tabular}{rl}
    ...
    \textbf{Instructor:} & Dr.\ Dam Quang Tuan \\
  \end{tabular}\par}

  \vspace{1.0cm}

  {\Large\bfseries Group 11\par}
  \vspace{0.4cm}
  {\large
  \begin{tabular}{ll}
    Nguyen Duy Tung      & 202416762 \\
    Le Xuan Nhat Khoi    & 202416711 \\
    Le Tuan Hung         & 202416800 \\
    Le Van Tuan Anh      & 202416657 \\
    Nguyen Tran Minh Tri & 202400116 \\
    Tran Manh Toan       & 202416753 \\
  \end{tabular}\par}
