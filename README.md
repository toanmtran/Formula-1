...
|---|---|---|
| [`src/lap_time_distributions/`](src/lap_time_distributions/) | Which probability distribution best describes lap times within a single race, and does the answer depend on the circuit or the regulation era? | Maximum-likelihood fits of Normal, Log-Normal, and Gamma distributions; Kolmogorov–Smirnov and chi-squared goodness-of-fit tests; AIC and BIC model selection; quantile–quantile diagnostics. |
